...
% Extra tests
% This one should return wrong answer in the testing because it has more than one solution (has two).
% test(puzzle_solution([[0,216,21,864,20], [216,_,_,_,2], [24,_,_,_,_], [25,_,_,_,_], [18,_,_,_,_]]), [puzzle_solution([[0,216,21,864,20],[216,9,3,4,2],[24,1,9,8,6],[25,6,7,9,3],[18,4,2,3,9]])],20,1).